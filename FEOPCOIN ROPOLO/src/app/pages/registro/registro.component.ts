...
import { HttpBackend, HttpErrorResponse, HttpStatusCode } from '@angular/common/http';
import { ErrorInterceptor } from 'src/app/services/auth/error.interceptor';
  ...
  onEnviar(event: Event, usuario:Usuario): void {
    ...
    if (this.form.valid)
    {
      ...
      this.usuarioService.crearUsuario(usuario).subscribe(
        data => {
          //console.log(data.id);
          //console.log("codigo estado",HttpStatusCode.Created);
          //console.log("codigo estado",HttpErrorResponse);
          
            if (data.ID_Rol>0)     //if (data.id>0)
